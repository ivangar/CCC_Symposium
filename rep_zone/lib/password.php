...
class Password
{
    ...
    private function checkFormDataNotEmpty()
    {
        if (!empty($_POST['user_name']) && !empty($_POST['user_password'])) {
            ...
            $this->feedback = "Veuillez entrer votre nom d'utilisateur";
        } elseif (empty($_POST['user_password'])) {
            $this->feedback = "Veuillez entrer votre mot de passe";
        }
        // default return
        return false;
    }
    ...
    private function validatePassword()
    {
        ...
        if ($result_row) {
            ...
            $this->feedback = "Il est impossible de valider le mot de passe";
        }
        // default return
        return false;
    }
