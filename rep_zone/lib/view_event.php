...
class ViewEvent
{
    ...
    {        
        $sql = "SELECT arrrival_meal_time, QA_time, program_end_time, program_start_time FROM agendas WHERE agenda_id = :agenda_id";
        $query = $this->db_connection->prepare($sql);
    ...
    {   
        ...
        (strcmp($province,'Colombie-Britannique') == 0 || strcmp($province,'British Columbia') == 0) ? $province_list .= "<option selected='selected' value='British Columbia'> Colombie-Britannique </option>" : $province_list .= "<option value='British Columbia'> Colombie-Britannique </option>";
        ...
        (strcmp($province,'Nouveau-Brunswick') == 0 || strcmp($province,'New Brunswick') == 0) ? $province_list .= "<option selected='selected' value='New Brunswick'> Nouveau-Brunswick </option>" : $province_list .= "<option value='New Brunswick'> Nouveau-Brunswick </option>";
        (strcmp($province,'Terre-Neuve et Labrador') == 0 || strcmp($province,'Newfoundland and Labrador') == 0) ? $province_list .= "<option selected='selected' value='Newfoundland and Labrador'> Terre-Neuve et Labrador </option>" : $province_list .= "<option value='Newfoundland and Labrador'> Terre-Neuve et Labrador </option>";
        (strcmp($province,'Nouvelle-Écosse') == 0 || strcmp($province,'Nova Scotia') == 0) ? $province_list .= "<option selected='selected' value='Nova Scotia'> Nouvelle-Écosse </option>" : $province_list .= "<option value='Nova Scotia'> Nouvelle-Écosse </option>";
        ...
        (strcmp($province,'Île-du-Prince-Édouard') == 0 || strcmp($province,'Prince Edward Island') == 0) ? $province_list .= "<option selected='selected' value='Prince Edward Island'> Île-du-Prince-Édouard </option>" : $province_list .= "<option value='Prince Edward Island'> Île-du-Prince-Édouard </option>";
        (strcmp($province,'Quebec') == 0 || strcmp($province,'Québec') == 0) ? $province_list .= "<option selected='selected' value='Quebec'> Québec </option>" : $province_list .= "<option value='Quebec'> Québec </option>";
    ...
    {        
        ...
        while($result_row = $query->fetch(PDO::FETCH_ASSOC) ){
            ...
            if($no_total_events == 1){
              ...
              $message = "Cette activité n'existe pas. Cliquez sur l'onglet 'Mes activités' pour afficher vos activités ou créez une nouvelle activité.";
    ...
    {   
        ...
        $sub_directory = UPLOAD_DIR . $newDir;
