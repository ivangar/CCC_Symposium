...
require_once("../lib/view_general_event.php");
...
<head>
    ...
    var upload_notification = "<div class='row'><div class='col-lg-12'><div class='alert alert-danger fade in' role='alert' ><p>Cette activité n'a pas les formulaires requis.</p></div></div></div>";
    var upload_table = "<div class='table-responsive table-bordered' id='forms_table'><table class='table' style='margin-bottom:0;'><tbody><tr id='COI_row'><td><div class='text-center'>Formulaire de déclaration de conflits d'intérêts de la SCC</div></td><td><div id='COI'>Téléverser</div></td></tr><tr id='honorarium_row'><td><div class='text-center'>Formulaire d’honoraires de la SCC</div></td><td><div id='honorarium'>Téléverser</div></td></tr><tr id='signin_row'><td><div class='text-center'>Feuille de présences</div></td><td><div id='signin'>Téléverser</div></td></tr><tr id='evaluation_row'><td><div class='text-center'>Formulaire d’évaluation</div></td><td><div id='evaluation'>Téléverser</div></td></tr></tbody></table></div>";
    </script>
</head>
    ...
    <div id="wrapper">
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level collapse in">
                                ...
                                <li>
                                    <a class="active" href="all_events.php"><i class="fa fa-list-alt fa-fw"></i> Toutes les activités</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
        ...
        <div id="page-wrapper">
            <div class="container-fluid" id="event-container">
                ...
                <?php if(isset($_SESSION["updated"]) && !empty($_SESSION["updated"]) ){ echo $_SESSION["updated"]; unset($_SESSION["updated"]); } ?>
                                        ...
                                        <form id="event_form" enctype="multipart/form-data" name="event_form" method="post" action="" role="form">
                                            <fieldset disabled>
                                                ...
                                                <div class="form-group required">
                                                    ...
                                                    <input type="text" class="form-control" id='eventDate' name="eventDate" placeholder="jj-mm-aaaa" data-error="Date event required" required value="<?php echo $myevent->event_info[0]; ?>">
                                                ...
                                                <div class="panel panel-default">
                                                    <div class="panel-heading">
                                                       <h2 style="margin-top:-10px;"> <small>Organisé par :</small> </h2>
                                                    </div>
                                                    <div class="panel-body">
                                                        <label >Nom : <?php echo $myevent->event_info[19]; ?></label><br>
                                                        <label>Compagnie : <?php echo $myevent->event_info[20]; ?></label><br>
                                                        <label>Adresse de courriel : <?php echo $myevent->event_info[21]; ?></label><br>
                                                        <label>Numéro de téléphone : <?php echo $myevent->event_info[22]; ?></label><br>
                                                    </div>
                                                </div> 
                                                <div class="panel panel-default"> 
                                                    <div class="panel-body">
                                                        ...
                                                        <div class="row"> 
                                                            <div class="col-xs-9 col-xs-offset-3">
                                                                <div class="form-group required">
                                                                    ...
                                                                    <input type="text" class="form-control" id="program_start_time" name="program_start_time" placeholder="00:00 am" data-error="Questions and answers time required" required value="<?php echo $myevent->event_info[23]; ?>">
                                                                    <div class="help-block with-errors"></div>
                                                                </div>
                                                            </div> 
                                                        </div>
                                                        ...
                                                        <div class="row"> 
                                                            <div class="col-xs-9 col-xs-offset-3">
                                                                <div class="form-group required">
                                                                    ...
                                                                    <input type="email" class="form-control" id="moderator_email" name="moderator_email" placeholder="courriel@courriel.com" data-error="moderator's email required (please provide a valid email)" required value="<?php echo $myevent->event_info[9]; ?>">
                                                                    <div class="help-block with-errors"></div>
                                                                </div>
                                                            </div> 
                                                        </div> 
                                            ...
                                            <?php if(isset($myevent->action) && !empty($myevent->action) ){ echo $myevent->action; } ?>
                                        </form>
                                    </div>
                                    <!-- /.col-lg-12 -->
                                </div>
