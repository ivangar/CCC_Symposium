...
$(document).ready(function () {
    ...
    $('[data-toggle="tooltip"]').tooltip({
        placement : 'right',
        title: "Le téléchargement de la vidéo peut prendre un certain temps selon votre vitesse d'internet."
    });
    	...
    	if( (element !== undefined) ){
    		for(var index = 0; index < videos.length; index++){
    			if(element === videos[index]){
    				...
    				var video_data =  "<div class='row'><div class='col-md-8'><p class='lead'>" + label + "</p></div></div><div class='row'><div class='col-md-8'>" + frame + "</div></div><div class='row'><div class='col-md-8' style='padding-top:25px;padding-bottom:25px;'> <p><button type='button' class='btn btn-outline btn-info btn-lg' id='reload'>Retourner</button></p> </div></div>";
